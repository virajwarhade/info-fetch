...
<div class="container-sm col-sm-6 col-12 mt-5 row mx-auto">
    ...
    <div class="mt-5 shadow rounded-3 bg-white border">
       ...
       <!-- <div class="mb-3">
          ...
          <input type="text"class="form-control" name="name" id="nameInput" aria-describedby="helpId" placeholder="">
        </div>
-->
  ...
  if (matches.length > 0) {
    ...
    dropdownMenu.hide();
        ...
        <div class="mb-3">
          ...
          <input type="number"
            class="form-control" name="phone" id="phno" aria-describedby="helpId" placeholder="">
